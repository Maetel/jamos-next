...
_ENV_PUBLIC.NEXT_PUBLIC_ACCESS_TOKEN = process.env.NEXT_PUBLIC_ACCESS_TOKEN_OVERRIDE ?? process.env.NEXT_PUBLIC_ACCESS_TOKEN;
////////////////////////////////////////////////////////////////////////
// Forked Area
////////////////////////////////////////////////////////////////////////
// Init Area
...
_ENV_PUBLIC.init_ENV_PUBLIC = () => {
  ...
  const variables = {
    ...
    NEXT_PUBLIC_ACCESS_TOKEN: _ENV_PUBLIC.NEXT_PUBLIC_ACCESS_TOKEN
  };
...
////////////////////////////////////////////////////////////////////////
// Common Area
_ENV_SERVER.MONGO_URL = process.env.MONGO_URL_OVERRIDE ?? process.env.MONGO_URL;
_ENV_SERVER.FIREBASE_APIKEY = process.env.FIREBASE_APIKEY_OVERRIDE ?? process.env.FIREBASE_APIKEY;
_ENV_SERVER.FIREBASE_AUTHDOMAIN = process.env.FIREBASE_AUTHDOMAIN_OVERRIDE ?? process.env.FIREBASE_AUTHDOMAIN;
_ENV_SERVER.FIREBASE_PROJECTID = process.env.FIREBASE_PROJECTID_OVERRIDE ?? process.env.FIREBASE_PROJECTID;
_ENV_SERVER.FIREBASE_STORAGEBUCKET = process.env.FIREBASE_STORAGEBUCKET_OVERRIDE ?? process.env.FIREBASE_STORAGEBUCKET;
_ENV_SERVER.FIREBASE_MESSAGINGSENDERID = process.env.FIREBASE_MESSAGINGSENDERID_OVERRIDE ?? process.env.FIREBASE_MESSAGINGSENDERID;
_ENV_SERVER.FIREBASE_APPID = process.env.FIREBASE_APPID_OVERRIDE ?? process.env.FIREBASE_APPID;
_ENV_SERVER.FIREBASE_MEASUREMENTID = process.env.FIREBASE_MEASUREMENTID_OVERRIDE ?? process.env.FIREBASE_MEASUREMENTID;
////////////////////////////////////////////////////////////////////////
// Forked Area
////////////////////////////////////////////////////////////////////////
// Init Area
...
_ENV_SERVER.init_ENV_SERVER = () => {
  ...
  const variables = {
    ...
    MONGO_URL: _ENV_SERVER.MONGO_URL,
    FIREBASE_APIKEY: _ENV_SERVER.FIREBASE_APIKEY,
    FIREBASE_AUTHDOMAIN: _ENV_SERVER.FIREBASE_AUTHDOMAIN,
    FIREBASE_PROJECTID: _ENV_SERVER.FIREBASE_PROJECTID,
    FIREBASE_STORAGEBUCKET: _ENV_SERVER.FIREBASE_STORAGEBUCKET,
    FIREBASE_MESSAGINGSENDERID: _ENV_SERVER.FIREBASE_MESSAGINGSENDERID,
    FIREBASE_APPID: _ENV_SERVER.FIREBASE_APPID,
    FIREBASE_MEASUREMENTID: _ENV_SERVER.FIREBASE_MEASUREMENTID
  };
  const isNullish = (val) => val === void 0 || val === null || (val == null ? void 0 : val.length) === 0;
  const missing = Object.keys(variables).filter((key) => isNullish(variables[key])).filter((key) => !key.toLowerCase().startsWith("nullable_"));
  if (missing.length > 0) {
